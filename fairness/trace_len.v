...
From fairness Require Import nat_omega inftraces utils_logic.
Import numbers.
...
Section TraceLen.
  ...
  Proof.
    ...
    opose proof (trace_len_uniq _ _ _ LEN H) as ->; eauto.
    lia_NO' len'. 
  Qed.
  ...
  Lemma trace_len_0_inv (tr: trace St L)
    ...
    False. 
  Proof.
    pose proof (proj1 (LEN1 0)). ospecialize (H _); eauto.
    red in H. lia. 
  Qed. 
  ...
  Proof. 
    destruct tr; eauto.
    pose proof (proj1 (LEN1 1)). ospecialize (H _); eauto.
    red in H. lia. 
  Qed.    
  ...
  Proof. 
    ...
    destruct (after i tr).
    - apply proj1 in LEN. ospecialize (LEN _); eauto. 
