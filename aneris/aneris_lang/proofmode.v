...
Proof.
  ...
  rewrite -aneris_wp_bind. eapply wand_apply; first by apply wand_entails, aneris_wp_load.
...
Proof.
  rewrite envs_entails_unseal=> ????.
  rewrite -aneris_wp_bind. eapply wand_apply; first by eapply wand_entails, aneris_wp_store.
...
Proof.
  rewrite envs_entails_unseal=> <- [? <-] ????.
  rewrite -aneris_wp_bind. eapply wand_apply; first by eapply wand_entails, aneris_wp_cas_fail.
  rewrite into_laterN_env_sound -later_sep envs_lookup_split //; simpl.
  by apply later_mono, sep_mono_r, wand_mono.
Qed.
...
Proof.
  ...
  rewrite -aneris_wp_bind. eapply wand_apply; first by eapply wand_entails, aneris_wp_cas_suc.
  rewrite into_laterN_env_sound -later_sep envs_simple_replace_sound //; simpl.
  rewrite right_id. by apply later_mono, sep_mono_r, wand_mono.
Qed.
...
Proof.
  ...
  eapply wand_apply; first by eapply wand_entails, aneris_wp_socketbind.
...
Proof.
  ...
  eapply wand_apply; first by eapply wand_entails, aneris_wp_send.
  rewrite into_laterN_env_sound -!later_sep; simpl.
...
Proof.
  ...
  eapply wand_apply; first by eapply wand_entails, aneris_wp_send_duplicate.
  rewrite into_laterN_env_sound -!later_sep; simpl.
  rewrite envs_lookup_intuitionistic_sound //; simpl.
  rewrite intuitionistically_elim.
