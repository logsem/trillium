...
Section Proof_of_server_listen.
  ...
  Proof.
    ...
    - iNext. iIntros (qlk γ_qlk) "#Hqlk".
      ...
      (* Search "fractional" "split". *)
      iDestruct (fractional.fractional_split
                   _ _ (1/3)%Qp (2/3)%Qp with "Hl") as "[Hl1 Hl2]";
        [apply mapsto_heap_as_fractional .. | |].
      { simpl. replace (1 / 3 + 2 / 3)%Qp with 1%Qp.
        { apply _. } 
