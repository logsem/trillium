        ...
        { iExists ({[m]} ∪ R0), ({[resp]} ∪ T00), cmv', γM.
          ...
          - apply bool_decide_eq_false_1 in Hkm.
            ...
            { iExists γi, cki. iFrame "HCkFi Htk0i".
              ...
              iFrame. iFrame "Hmono".
              iDestruct "Hckf" as (?) "[H1 H2]". subst. iFrame.
              iDestruct (session_token_agree with "H1 Htk0i") as %->.
              iDestruct (session_token_agree with "Htk0i Hslk") as %->.
              iFrame "∗#".              
              done. }
            iExists γi, cki. iSplitL "HCkFi".
            { iFrame "#∗".
              destruct Hhst1i as (y0 & ? & ? & ? & ?).
              destruct Hhst2i as (y1 & ? & ? & ? & ?).
              iSplit.
              { simpl in *. subst.
                iDestruct "HCkFi" as (?) "[H1 H2]". subst. iFrame.
                iDestruct (session_token_agree with "H1 Htk0i") as %->.
                iFrame. }
              iDestruct "HCkFi" as (?) "[H1 H2]". subst. iFrame.
              iDestruct (session_token_agree with "H1 Htk0i") as %->.
