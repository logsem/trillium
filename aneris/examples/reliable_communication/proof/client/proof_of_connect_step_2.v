...
Section Proof_of_connect_step_2.
  ...
  Proof.
    ...
    iDestruct "Hcn" as "(#Htk & Hcn)". iSplitR; [done|].
    iRight. iSplit; first done. subst; iFrame; eauto.
  Qed.
  ...
  Proof.
    ...
    2:{ iIntros (v) "HQ".
        ...
        iExists _. do 4 (iSplit; first done).
        iFrame "#∗"; eauto. }
       ...
       ** iDestruct "Hres" as (s2 i2 ->) "Hres". wp_pures.
          ...
          *** subst i2. case_bool_decide as Heq1; wp_pures; last done.
              ...
              **** iApply "HΨ". inversion Heq1.
                   ...
                   iSplit; first eauto. iFrame "Hgh". iFrame "Hh".
                   iFrame "#∗".
